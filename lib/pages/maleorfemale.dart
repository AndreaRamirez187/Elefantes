...
class Pagemaleorfemale extends StatelessWidget {
  const Pagemaleorfemale({
    Key? key,
  }) : super(key: key);
        ...
        children: [
          const SizedBox(
            ...
            Row(
              ...
              children: <Widget>[ 
                Container(
                  child: Image.asset('assets/img/cherry2.gif',
                  width: 95,
                  height: 100,
                  fit: BoxFit.cover), 
          ...
          TextButton.icon(
                  ...
                  icon: Image.asset('assets/img/female.png', fit: BoxFit.cover ,),
                  label: const Text(
                    'Female Elephants',
                    style: TextStyle(
          ...
          TextButton.icon(
                  ...
                  icon: Image.asset('assets/img/male.png', fit: BoxFit.cover ,),
          ...
          const SizedBox(
               ...
               Container(
                 decoration: BoxDecoration(borderRadius: BorderRadius.circular(10), gradient: const LinearGradient(colors: [ Color(0xffED74A1), Colors.white ]),
                  ...
                  child: Image.asset('assets/img/couple.gif',
                  width: 420,
                  height: 300,
                  fit: BoxFit.cover), 
